...
### Tip-of-the-week
As I mentioned before, C++ isn't too difficult of a language to pick up especially if you are fimilar with java and C. So before the semester begins or at the beginning, I would recommend brushing up on the general topics that you learn from them such as classes and inheritence from java as well as pointers and memory management from C.
